#!/usr/bin/env python3
# Copyright (c) 2021-2021 The Bitcoin Republic Core developers
...
class I2PPorts(BitcoinRepublicTestFramework):
    ...
    def run_test(self):
        ...
        addr = "zsxwyo6qcn3chqzwxnseusqgsnuw3maqnztkiypyfxtya4snkoka.b32.i2p:33731"
        raised = False
        try:
