...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/sherkitty/bitcoinrepublic/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(BitcoinRepublicTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/sherkitty/bitcoinrepublic/blob/master/doc/tracing.md#tracepoint-validationblock_connected
