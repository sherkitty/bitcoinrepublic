...
Verify that a bitcoinrepublicd node can use an external signer command.
...
class RPCSignerTest(BitcoinRepublicTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart bitcoinrepublicd with -signer=<cmd>',
