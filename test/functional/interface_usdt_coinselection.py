...
"""  Tests the coin_selection:* tracepoint API interface.
     See https://github.com/sherkitty/bitcoinrepublic/blob/master/doc/tracing.md#context-coin_selection
"""
...
class CoinSelectionTracepointTest(BitcoinRepublicTestFramework):
