...
# TestP2PConn: A peer we use to send messages to bitcoinrepublicd, and store responses.
...
class CompactBlocksTest(BitcoinRepublicTestFramework):
    ...
    # This test actually causes bitcoinrepublicd to (reasonably!) disconnect us, so do this last.
    ...
    # bitcoinrepublicd's choice of nonce.
    ...
    # Test that bitcoinrepublicd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for bitcoinrepublicd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        node = self.nodes[0]
        # bitcoinrepublicd will not send blocktxn responses for blocks whose height is
