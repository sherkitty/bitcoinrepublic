...
"""
Test starting bitcoinrepublicd with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(BitcoinRepublicTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that bitcoinrepublicd has bound on "::1" (for RPC) and "::" (for P2P).
