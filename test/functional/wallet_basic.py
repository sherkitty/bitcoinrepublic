...
class WalletTest(BitcoinRepublicTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 BTCREP from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 BTCREP with subtract fee from amount
        ...
        # Sendmany 10 BTCREP with subtract fee from amount
        ...
        if not self.options.descriptors:
            ...
            # This will raise an exception for attempting to get the private key of an invalid BitcoinRepublic address
            assert_raises_rpc_error(-5, "Invalid BitcoinRepublic address", self.nodes[0].dumpprivkey, "invalid")

            # This will raise an exception for attempting to set a label for an invalid BitcoinRepublic address
            assert_raises_rpc_error(-5, "Invalid BitcoinRepublic address", self.nodes[0].setlabel, "invalid address", "label")

            # This will raise an exception for importing an invalid address
            assert_raises_rpc_error(-5, "Invalid BitcoinRepublic address or script", self.nodes[0].importaddress, "invalid")
