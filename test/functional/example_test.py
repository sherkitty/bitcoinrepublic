...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BitcoinRepublicTestFramework
    pass


class ExampleTest(BitcoinRepublicTestFramework):
    # Each functional test is a subclass of the BitcoinRepublicTestFramework class.
    ...
    def custom_method(self):
        ...
        BitcoinRepublicTestFramework class so other tests can use it."""
