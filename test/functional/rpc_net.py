...
class NetTest(BitcoinRepublicTestFramework):
    ...
    def test_getnodeaddresses(self):
        ...
        self.nodes[0].addpeeraddress(address=ipv6_addr, port=33731)
        ...
        for i in range(10000):
            ...
            self.nodes[0].addpeeraddress(a, 33731)
    ...
    def test_addpeeraddress(self):
        ...
        assert_equal(node.addpeeraddress(address="", port=33731), {"success": False})
