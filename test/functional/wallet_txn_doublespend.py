...
class TxnMallTest(BitcoinRepublicTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 BTCREP:
        ...
        # First: use raw transaction API to send 1240 BTCREP to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 BTCREP coin each
        ...
        # Node0's balance should be starting balance, plus 50BTCREP for another
        ...
        # Node0's total balance should be starting balance, plus 100BTCREP for
