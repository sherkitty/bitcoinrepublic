...
class TestShell:
    """Wrapper Class for BitcoinRepublicTestFramework.

    The TestShell class extends the BitcoinRepublicTestFramework
    ...
    class __TestShell(BitcoinRepublicTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by BitcoinRepublicTestFramework child class.
            self.num_nodes = 1
