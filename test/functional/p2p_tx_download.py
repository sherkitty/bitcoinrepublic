...
class TxDownloadTest(BitcoinRepublicTestFramework):
    ...
    def run_test(self):
        ...
        # Run each test against new bitcoinrepublicd instances, as setting mocktimes has long-term effects on when
