...
By default, bitcoinrepublicd will dump mempool on shutdown and
...
class MempoolPersistTest(BitcoinRepublicTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent bitcoinrepublicd from writing mempool.dat to disk. Verify that `savemempool` fails")
