...
# The block reward of coinbaseoutput.nValue (50) BTCREP/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 BTCREP/block.
...
class TestBitcoinRepublicCli(BitcoinRepublicTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `bitcoinrepublic-cli getblockchaininfo`")
        ...
        self.log.info("Test -getinfo and bitcoinrepublic-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and bitcoinrepublic-cli getwalletinfo return expected wallet info")
            ...
            assert_equal(Decimal(cli_get_info['Transaction fee rate (-paytxfee) (BTCREP/kvB)']), wallet_info['paytxfee'])
            assert_equal(Decimal(cli_get_info['Min tx relay fee rate (BTCREP/kvB)']), network_info['relayfee'])
            ...
            # Mine a block to confirm; adds a block reward (50 BTCREP) to the default wallet.
            ...
            # Test bitcoinrepublic-cli -generate.
            n1 = 3
            n2 = 4
            ...
            # Test bitcoinrepublic-cli -generate with -rpcwallet in multiwallet mode.
