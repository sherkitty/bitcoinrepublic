...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/sherkitty/bitcoinrepublic/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(BitcoinRepublicTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our bitcoinrepublicd node")
