...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef BITCOINREPUBLIC_CHAINPARAMSSEEDS_H\n')
    g.write('#define BITCOINREPUBLIC_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the bitcoinrepublic network\n')
    ...
    g.write('#endif // BITCOINREPUBLIC_CHAINPARAMSSEEDS_H\n')
