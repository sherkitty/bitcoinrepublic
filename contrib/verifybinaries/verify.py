...
WORKINGDIR = "/tmp/bitcoinrepublic_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1 = "https://github.com/sherkitty/bitcoinrepublic.git"
HOST2 = "https://bitcoinrepublic.org"
VERSIONPREFIX = "bitcoinrepublic-core-"
...
def main(args):
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the BitcoinRepublic Core binary release "
