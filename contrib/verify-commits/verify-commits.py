...
def tree_sha512sum(commit='HEAD'):
    ...
    This is copied from github-merge.py. See https://github.com/bitcoinrepublic-core/bitcoinrepublic-maintainer-tools."""
...
def main():
    ...
    while True:
        ...
        os.environ['BITCOINREPUBLIC_VERIFY_COMMITS_ALLOW_SHA1'] = "0" if no_sha1 else "1"
