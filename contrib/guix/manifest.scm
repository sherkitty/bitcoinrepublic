...
(define* (make-bitcoinrepublic-cross-toolchain target
                                       #:key
...
desirable for building BitcoinRepublic Core release binaries."
  ...
  (let ((target (getenv "HOST")))
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list (make-bitcoinrepublic-cross-toolchain target)))
