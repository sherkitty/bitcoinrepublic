...
complete --command bitcoinrepublicd --no-files

# Extract options
function __fish_bitcoinrepublicd_get_options
...
complete \
    --command bitcoinrepublicd \
    --arguments "(__fish_bitcoinrepublicd_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete --command bitcoinrepublicd \
...
complete \
    --command bitcoinrepublicd \
    --arguments "(__fish_bitcoinrepublicd_get_options --nofiles)"
