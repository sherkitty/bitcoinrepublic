...
complete --command bitcoinrepublic-tx --no-files

# Modified version of __fish_seen_subcommand_from
# Uses regex to detect cmd= syntax
function __fish_bitcoinrepublic_seen_cmd
...
# Extract options
function __fish_bitcoinrepublic_tx_get_options
...
# Extract commands
function __fish_bitcoinrepublic_tx_get_commands
...
# Add options
complete \
    --command bitcoinrepublic-tx \
    --condition "not __fish_bitcoinrepublic_seen_cmd (__fish_bitcoinrepublic_tx_get_commands --commandsonly)" \
    --arguments "(__fish_bitcoinrepublic_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command bitcoinrepublic-tx \
    --arguments "(__fish_bitcoinrepublic_tx_get_commands)" \
    --no-files
