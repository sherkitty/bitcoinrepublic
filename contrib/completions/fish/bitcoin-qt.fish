...
complete --command bitcoinrepublic-qt --no-files

# Extract options
function __fish_bitcoinrepublicqt_get_options
...
complete \
    --command bitcoinrepublic-qt \
    --arguments "(__fish_bitcoinrepublicqt_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete -c bitcoinrepublic-qt \
...
complete \
    --command bitcoinrepublic-qt \
    --arguments "(__fish_bitcoinrepublicqt_get_options --nofiles)"
