...
"""Example logging BitcoinRepublic Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/bitcoinrepublicd
...
def main(bitcoinrepublicd_path):
    ...
    b = BPF(text=program, usdt_contexts=[bitcoinrepublicd_with_usdts])
