...
#ifndef BITCOINREPUBLIC_NODE_CONNECTION_TYPES_H
#define BITCOINREPUBLIC_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/bitcoinrepublic-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on BitcoinRepublic’s Peer-to-Peer Network")
...
#endif // BITCOINREPUBLIC_NODE_CONNECTION_TYPES_H
