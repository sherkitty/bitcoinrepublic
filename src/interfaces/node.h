...
#ifndef BITCOINREPUBLIC_INTERFACES_NODE_H
#define BITCOINREPUBLIC_INTERFACES_NODE_H
...
//! Top-level interface for a bitcoinrepublic node (bitcoinrepublicd process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or bitcoinrepublic.conf.
...
#endif // BITCOINREPUBLIC_INTERFACES_NODE_H
