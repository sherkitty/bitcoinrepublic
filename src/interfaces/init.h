...
#ifndef BITCOINREPUBLIC_INTERFACES_INIT_H
#define BITCOINREPUBLIC_INTERFACES_INIT_H
...
//! (bitcoinrepublic-gui, bitcoinrepublic-node, bitcoinrepublic-wallet, bitcoinrepublicd, bitcoinrepublic-qt) and each
...
#endif // BITCOINREPUBLIC_INTERFACES_INIT_H
