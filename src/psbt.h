...
#ifndef BITCOINREPUBLIC_PSBT_H
#define BITCOINREPUBLIC_PSBT_H
...
struct PartiallySignedTransaction
{
    ...
    /** Merge psbt into this. The two psbts must have the same underlying CTransaction (i.e. the
      * same actual BitcoinRepublic transaction.) Returns true if the merge succeeded, false otherwise. */
