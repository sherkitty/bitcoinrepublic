...
// Copyright 2015 BitcoinRepublic Core Developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or https://opensource.org/licenses/mit-license.php.

#ifndef BITCOINREPUBLIC_UNIVALUE_INCLUDE_UNIVALUE_H
#define BITCOINREPUBLIC_UNIVALUE_INCLUDE_UNIVALUE_H
...
#endif // BITCOINREPUBLIC_UNIVALUE_INCLUDE_UNIVALUE_H
