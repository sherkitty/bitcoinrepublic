...
#ifndef BITCOINREPUBLIC_RPC_PROTOCOL_H
#define BITCOINREPUBLIC_RPC_PROTOCOL_H
...
//! BitcoinRepublic RPC error codes
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in bitcoinrepublicd
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< BitcoinRepublic is not connected
...
#endif // BITCOINREPUBLIC_RPC_PROTOCOL_H
