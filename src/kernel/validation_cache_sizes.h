...
#ifndef BITCOINREPUBLIC_KERNEL_VALIDATION_CACHE_SIZES_H
#define BITCOINREPUBLIC_KERNEL_VALIDATION_CACHE_SIZES_H
...
#endif // BITCOINREPUBLIC_KERNEL_VALIDATION_CACHE_SIZES_H
