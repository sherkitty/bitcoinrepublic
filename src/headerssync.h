...
#ifndef BITCOINREPUBLIC_HEADERSSYNC_H
#define BITCOINREPUBLIC_HEADERSSYNC_H
 ...
 *
 * The BitcoinRepublic protocol does not offer an easy way to determine the work on a
...
#endif // BITCOINREPUBLIC_HEADERSSYNC_H
