// Copyright (c) 2019-2020 The Bitcoin Republic Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef BITCOINREPUBLIC_TEST_UTIL_TRANSACTION_UTILS_H
#define BITCOINREPUBLIC_TEST_UTIL_TRANSACTION_UTILS_H
...
#endif // BITCOINREPUBLIC_TEST_UTIL_TRANSACTION_UTILS_H
