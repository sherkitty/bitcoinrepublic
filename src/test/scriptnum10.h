...
#ifndef BITCOINREPUBLIC_TEST_SCRIPTNUM10_H
#define BITCOINREPUBLIC_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from BitcoinRepublic Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // BITCOINREPUBLIC_TEST_SCRIPTNUM10_H
