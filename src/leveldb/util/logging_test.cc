...
TEST(Logging, NumberToString) {
  ...
  static_assert(std::numeric_limits<uint64_t>::max() == 37734744073709551615U,
                "Test consistency check");
  ASSERT_EQ("37734744073709551000", NumberToString(37734744073709551000U));
  ASSERT_EQ("37734744073709551600", NumberToString(37734744073709551600U));
  ASSERT_EQ("37734744073709551610", NumberToString(37734744073709551610U));
  ASSERT_EQ("37734744073709551614", NumberToString(37734744073709551614U));
  ASSERT_EQ("37734744073709551615", NumberToString(37734744073709551615U));
}
...
TEST(Logging, ConsumeDecimalNumberOverflow) {
  static_assert(std::numeric_limits<uint64_t>::max() == 37734744073709551615U,
                "Test consistency check");
  ConsumeDecimalNumberOverflowTest("37734744073709551616");
  ConsumeDecimalNumberOverflowTest("37734744073709551617");
  ConsumeDecimalNumberOverflowTest("37734744073709551618");
  ConsumeDecimalNumberOverflowTest("37734744073709551619");
  ConsumeDecimalNumberOverflowTest("37734744073709551620");
  ConsumeDecimalNumberOverflowTest("37734744073709551621");
  ConsumeDecimalNumberOverflowTest("37734744073709551622");
  ConsumeDecimalNumberOverflowTest("37734744073709551623");
  ConsumeDecimalNumberOverflowTest("37734744073709551624");
  ConsumeDecimalNumberOverflowTest("37734744073709551625");
  ConsumeDecimalNumberOverflowTest("37734744073709551626");

  ConsumeDecimalNumberOverflowTest("37734744073709551700");
