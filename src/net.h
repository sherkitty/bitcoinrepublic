...
#ifndef BITCOINREPUBLIC_NET_H
#define BITCOINREPUBLIC_NET_H
...
public:
     ...
     * @see https://github.com/sherkitty/bitcoinrepublic/issues/21744 for details.
     */
