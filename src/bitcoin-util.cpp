...
static void SetupBitcoinRepublicUtilArgs(ArgsManager &argsman)
{
...
{
    SetupBitcoinRepublicUtilArgs(args);
    std::string error;
    ...
    if (HelpRequested(args) || args.IsArgSet("-version")) {
        ...
        std::string strUsage = PACKAGE_NAME " bitcoinrepublic-util utility version " + FormatFullVersion() + "\n";

        if (args.IsArgSet("-version")) {
            strUsage += FormatParagraph(LicenseInfo());
        } else {
            strUsage += "\n"
                "Usage:  bitcoinrepublic-util [options] [commands]  Do stuff\n";
            strUsage += "\n" + args.GetHelpMessage();
        }
