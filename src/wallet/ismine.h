...
#ifndef BITCOINREPUBLIC_WALLET_ISMINE_H
#define BITCOINREPUBLIC_WALLET_ISMINE_H
 ...
 * https://github.com/sherkitty/bitcoinrepublic/blob/master/doc/release-notes/release-notes-0.21.0.md#ismine-semantics
...
#endif // BITCOINREPUBLIC_WALLET_ISMINE_H
