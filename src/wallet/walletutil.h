...
#ifndef BITCOINREPUBLIC_WALLET_WALLETUTIL_H
#define BITCOINREPUBLIC_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! bitcoinrepublic from opening the wallet, thinking it was newly created, and
...
#endif // BITCOINREPUBLIC_WALLET_WALLETUTIL_H
