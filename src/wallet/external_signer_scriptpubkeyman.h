...
#ifndef BITCOINREPUBLIC_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define BITCOINREPUBLIC_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // BITCOINREPUBLIC_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
