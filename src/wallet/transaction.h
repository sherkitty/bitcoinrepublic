...
#ifndef BITCOINREPUBLIC_WALLET_TRANSACTION_H
#define BITCOINREPUBLIC_WALLET_TRANSACTION_H
...
public:
     ...
     * on this bitcoinrepublic node, and set to 0 for transactions that were created
...
#endif // BITCOINREPUBLIC_WALLET_TRANSACTION_H
