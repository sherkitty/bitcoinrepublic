...
#ifndef BITCOINREPUBLIC_IPC_PROCESS_H
#define BITCOINREPUBLIC_IPC_PROCESS_H
...
//! IPC process interface for spawning bitcoinrepublic processes and serving requests
...
#endif // BITCOINREPUBLIC_IPC_PROCESS_H
