...
#ifndef BITCOINREPUBLIC_QT_GUIUTIL_H
#define BITCOINREPUBLIC_QT_GUIUTIL_H
...
/** Utility functions used by the BitcoinRepublic Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "bitcoinrepublic:" URI into recipient object, return true on successful parsing
...
#endif // BITCOINREPUBLIC_QT_GUIUTIL_H
