...
#ifndef BITCOINREPUBLIC_QT_WALLETMODEL_H
#define BITCOINREPUBLIC_QT_WALLETMODEL_H
...
/** Interface to BitcoinRepublic wallet from Qt view code. */
...
#endif // BITCOINREPUBLIC_QT_WALLETMODEL_H
