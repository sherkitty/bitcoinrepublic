...
#ifndef BITCOINREPUBLIC_QT_CLIENTMODEL_H
#define BITCOINREPUBLIC_QT_CLIENTMODEL_H
...
/** Model for BitcoinRepublic network client. */
...
#endif // BITCOINREPUBLIC_QT_CLIENTMODEL_H
