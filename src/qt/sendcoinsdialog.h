...
#ifndef BITCOINREPUBLIC_QT_SENDCOINSDIALOG_H
#define BITCOINREPUBLIC_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending bitcoinrepublics */
...
#endif // BITCOINREPUBLIC_QT_SENDCOINSDIALOG_H
