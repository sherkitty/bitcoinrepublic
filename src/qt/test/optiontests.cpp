...
{
    // Test regression https://github.com/sherkitty/bitcoinrepublic/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/sherkitty/bitcoinrepublic-gui/issues/567 does not resurface.
    // It was fixed via https://github.com/sherkitty/bitcoinrepublic-gui/pull/568.
    // With fListen=false in ~/.config/BitcoinRepublic/BitcoinRepublic-Qt.conf and all else left as default,
    // bitcoinrepublic-qt should set both -listen and -listenonion to false and start successfully.
