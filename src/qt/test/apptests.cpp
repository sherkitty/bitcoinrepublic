...
//! Entry point for BitcoinRepublicApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &BitcoinRepublicApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for BitcoinRepublicGUI tests.
void AppTests::guiTests(BitcoinRepublicGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &BitcoinRepublicGUI::consoleShown, this, &AppTests::consoleTests);
