      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->bitcoinrepublicAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->bitcoinrepublicAtStartup);
    ...
    ui->bitcoinrepublicAtStartup->setToolTip(ui->bitcoinrepublicAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->bitcoinrepublicAtStartup->setText(ui->bitcoinrepublicAtStartup->text().arg(PACKAGE_NAME));

    ui->openBitcoinRepublicConfButton->setToolTip(ui->openBitcoinRepublicConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new BitcoinRepublicUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->bitcoinrepublicAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSBTCREPontrols);
...
void OptionsDialog::on_openBitcoinRepublicConfButton_clicked()
{
    ...
    if (!GUIUtil::openBitcoinRepublicConf())
