...
#ifndef BITCOINREPUBLIC_SCRIPT_STANDARD_H
#define BITCOINREPUBLIC_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a bitcoinrepublic address
 */
...
/**
 * Generate a BitcoinRepublic scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // BITCOINREPUBLIC_SCRIPT_STANDARD_H
