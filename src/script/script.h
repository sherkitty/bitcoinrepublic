...
#ifndef BITCOINREPUBLIC_SCRIPT_SCRIPT_H
#define BITCOINREPUBLIC_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, BitcoinRepublic always counted CHECKMULTISIGs
...
#endif // BITCOINREPUBLIC_SCRIPT_SCRIPT_H
