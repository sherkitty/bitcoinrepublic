...
#ifndef BITCOINREPUBLIC_SCRIPT_MINISCRIPT_H
#define BITCOINREPUBLIC_SCRIPT_MINISCRIPT_H
...
//! Parse a miniscript from a bitcoinrepublic script
...
#endif // BITCOINREPUBLIC_SCRIPT_MINISCRIPT_H
