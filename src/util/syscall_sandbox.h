...
#ifndef BITCOINREPUBLIC_UTIL_SYSCALL_SANDBOX_H
#define BITCOINREPUBLIC_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during bitcoinrepublicd initialization if BitcoinRepublic Core was compiled
...
#endif // BITCOINREPUBLIC_UTIL_SYSCALL_SANDBOX_H
