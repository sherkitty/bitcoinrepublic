// Copyright (c) 2010-2021 The Bitcoin Republic Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef BITCOINREPUBLIC_UTIL_ERROR_H
#define BITCOINREPUBLIC_UTIL_ERROR_H
...
#endif // BITCOINREPUBLIC_UTIL_ERROR_H
