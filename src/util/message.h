...
#ifndef BITCOINREPUBLIC_UTIL_MESSAGE_H
#define BITCOINREPUBLIC_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's bitcoinrepublic address, it must refer to a public key.
...
#endif // BITCOINREPUBLIC_UTIL_MESSAGE_H
