...
#ifndef BITCOINREPUBLIC_UTIL_SETTINGS_H
#define BITCOINREPUBLIC_UTIL_SETTINGS_H
...
//!       https://github.com/sherkitty/bitcoinrepublic.git/15934/files#r337691812)
...
#endif // BITCOINREPUBLIC_UTIL_SETTINGS_H
