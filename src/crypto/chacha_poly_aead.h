// Copyright (c) 2019-2021 The Bitcoin Republic Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef BITCOINREPUBLIC_CRYPTO_CHACHA_POLY_AEAD_H
#define BITCOINREPUBLIC_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@bitcoinrepublic.
 *
 ...
 *
 * The chacha20-poly1305@bitcoinrepublic combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@bitcoinrepublic cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@bitcoinrepublic are relatively fast in
...
#endif // BITCOINREPUBLIC_CRYPTO_CHACHA_POLY_AEAD_H
