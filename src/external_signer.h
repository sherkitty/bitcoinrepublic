...
#ifndef BITCOINREPUBLIC_EXTERNAL_SIGNER_H
#define BITCOINREPUBLIC_EXTERNAL_SIGNER_H
...
private:
    ...
    //! BitcoinRepublic mainnet, testnet, etc
    std::string m_chain;
...
#endif // BITCOINREPUBLIC_EXTERNAL_SIGNER_H
