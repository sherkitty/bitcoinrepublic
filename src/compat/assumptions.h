...
#ifndef BITCOINREPUBLIC_COMPAT_ASSUMPTIONS_H
#define BITCOINREPUBLIC_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "BitcoinRepublic cannot be compiled without assertions."
#endif
...
#endif // BITCOINREPUBLIC_COMPAT_ASSUMPTIONS_H
