...
#ifndef BITCOINREPUBLIC_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define BITCOINREPUBLIC_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // BITCOINREPUBLIC_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
