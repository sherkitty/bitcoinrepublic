...
#ifndef BITCOINREPUBLIC_ARITH_UINT256_H
#define BITCOINREPUBLIC_ARITH_UINT256_H
...
public:
     ...
     *
     * BitcoinRepublic only uses this "compact" format for encoding difficulty
...
#endif // BITCOINREPUBLIC_ARITH_UINT256_H
