...
libs = [
    'libbitcoinrepublic_cli',
    'libbitcoinrepublic_common',
    'libbitcoinrepublic_crypto',
    'libbitcoinrepublic_node',
    'libbitcoinrepublic_util',
    'libbitcoinrepublic_wallet_tool',
    'libbitcoinrepublic_wallet',
    'libbitcoinrepublic_zmq',
    'bench_bitcoinrepublic',
    'libtest_util',
]
...
def parse_config_into_btc_config():
    ...
    config_dict["PACKAGE_STRING"] = f"\"BitcoinRepublic Core {version}\""

    with open(os.path.join(SOURCE_DIR,'../build_msvc/bitcoinrepublic_config.h.in'), "r", encoding="utf8") as template_file:
    ...
    with open(os.path.join(SOURCE_DIR,'../build_msvc/bitcoinrepublic_config.h'), "w", encoding="utf8") as btc_config:
...
def main():
    parser = argparse.ArgumentParser(description='BitcoinRepublic-core msbuild configuration initialiser.')
    ...
    copyfile(os.path.join(SOURCE_DIR,'../build_msvc/bitcoinrepublic_config.h'), os.path.join(SOURCE_DIR, 'config/bitcoinrepublic-config.h'))
