...
This document provides guidelines for internationalization of the BitcoinRepublic Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitcoinrepublic_en.ts` remains unchanged.
