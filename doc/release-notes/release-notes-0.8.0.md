BitcoinRepublic-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bitcoinrepublic/files/BitcoinRepublic/bitcoinrepublic-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the BitcoinRepublic
...
New/changed settings (command-line or bitcoinrepublic.conf file)
--------------------------------------------------------
