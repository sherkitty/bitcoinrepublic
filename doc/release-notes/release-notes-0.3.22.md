Download URL: https://sourceforge.net/projects/bitcoinrepublic/files/BitcoinRepublic/bitcoinrepublic-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 BTCREP fee schedule (users still pay 0.01 BTCREP per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #bitcoinrepublic00 - #bitcoinrepublic99
