BitcoinRepublic Core version 0.13.2 is now available from:

  <https://bitcoinrepublic.org/bin/bitcoinrepublic-core-0.13.2/>
...
- #8908 `4a974b2` Update bitcoinrepublic-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bitcoinrepublic-tx to create v2 transactions (btcdrak)
