BitcoinRepublic Core version *0.15.0.1* is now available from:

  <https://bitcoinrepublic.org/bin/bitcoinrepublic-core-0.15.0.1/>

and

  <https://github.com/sherkitty/bitcoinrepublicbin/bitcoinrepublic-core-0.15.0.1/>
