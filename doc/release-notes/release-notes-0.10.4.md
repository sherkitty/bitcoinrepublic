BitcoinRepublic Core version 0.10.4 is now available from:

  <https://bitcoinrepublic.org/bin/bitcoinrepublic-core-0.10.4/>
...
- #6953 `43c2789` Split bitcoinrepublic-tx into its own package
- #6953 `dfe0d4d` Include bitcoinrepublic-tx binary on Debian/Ubuntu
