BitcoinRepublic Core version *0.15.2* is now available from:

  <https://github.com/sherkitty/bitcoinrepublicbin/bitcoinrepublic-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in bitcoinrepublic-tx (TheBlueMatt)
