BitcoinRepublic version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcoinrepublic/files/BitcoinRepublic/bitcoinrepublic-0.5.4/
...
http://gitorious.org/bitcoinrepublic/bitcoinrepublicd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix BitcoinRepublic-Qt notifications under Growl 1.3.
Increase required age of BitcoinRepublic-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoinRepublic properly when installing BitcoinRepublic-Qt over it. (Windows)
