BitcoinRepublic Core version 0.9.4 is now available from:

  https://bitcoinrepublic.org/bin/0.9.4/
...
this update is incompatible with the BitcoinRepublic system and could lead to consensus
forks.

BitcoinRepublic Core released binaries from https://bitcoinrepublic.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitcoinrepublic/+archive/ubuntu/bitcoinrepublic
- A third-party or self-compiled BitcoinRepublic Core

upgrade to BitcoinRepublic Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
