BitcoinRepublic Core version 0.9.2.1 is now available from:

  https://bitcoinrepublic.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 BTCREP to 0.01 BTCREP
...
- Fix "Start bitcoinrepublic on system login"
